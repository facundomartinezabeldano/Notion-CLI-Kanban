...
def list_tasks_action():
    query = notion.databases.query(database_id="63cd54d3b2254b02b9f258c52e38400a")['results']
    ...
    with alive_bar(len(urls)) as bar:
        for url in urls:
            ...
            r = [
                ...
                p['properties']['Short Description']['rich_text'][0]['text']['content'], #Description
...
def add_task_action(request):
    ...
    notion.pages.create( parent={'database_id': '63cd54d3b2254b02b9f258c52e38400a'}, properties= payload)
